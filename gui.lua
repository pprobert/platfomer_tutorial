...
function GUI:load()
    self.coins = {}
    self.coins.img = love.graphics.newImage("assests/coin.png")
    ...
    self.hearts = {}
    self.hearts.img = love.graphics.newImage("assests/heart.png")
    ...
    self.font = love.graphics.newFont("assests/bit.ttf", 36)
end
